...
include('includes/login.html');
    ...
    if ( mysqli_num_rows( $r ) > 0 )
    {
		...
		<a id="link1" class="nav-link" href="login.php">Log in to book tickets.</a>
		<a id="link1" class="nav-link" href="register.php">Not registered with Ecinema yet? Register now!</a>
		<br>
			<div class="row">
